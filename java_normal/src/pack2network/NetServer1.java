...
//소켓간 통신을 위해서는 네트워크상에서 클라이언트와 서버에 해당되는 컴퓨터를 식별하기 위한 IP주소와
...
public class NetServer1 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		try {
			serverSocket = new ServerSocket(8888);	// ip와 port number를 binding 한 후 listening
			System.out.println("서버 서비스 시작 ...");
			
			// 서버 소켓이 클라이언트 요청을 대기하다가 접속하면 클라이언트와 통신하기 위한 Socket 객체 생성
