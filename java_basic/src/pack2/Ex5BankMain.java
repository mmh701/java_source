...
public class Ex5BankMain {
	public static void main(String[] args) {
		...
		tom.dePosit(5000);
		tom.withDraw(3000);
		System.out.println("tom의 잔고: " + tom.getMoney() + "원");
		
		System.out.println();
		Ex5Bank oscar = new Ex5Bank(2000);
		oscar.dePosit(1000);
		oscar.withDraw(6000);
		System.out.println("oscar의 잔고: " + oscar.getMoney() + "원");
		...
		james = oscar; // 주소를 치환. 하나의 객체를 두 개의 객체 변수가 참조
		...
		String ss1 = "kor"; // String 클래스는 클래스이지만 기본형 처럼 사용할 수 있도록 자바가 배려
		...
		System.out.println(bank1.imsi); // default 멤버 접근 가능
		System.out.println(bank1.imsi2); // public 멤버 접근 가능
